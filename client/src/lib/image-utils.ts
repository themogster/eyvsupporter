    ...
    return new Promise((resolve, reject) => {
      ...
      img.onload = () => {
        try {
          ...
          this.ctx.beginPath();
          this.ctx.arc(90, 90, 82, 0, Math.PI * 2);
          this.ctx.strokeStyle = getComputedStyle(document.documentElement).getPropertyValue('--deep-purple') || '#611284';
          ...
          this.ctx.fillStyle = getComputedStyle(document.documentElement).getPropertyValue('--deep-purple') || '#611284';
